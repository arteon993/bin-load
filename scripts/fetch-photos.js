...
const PLACES = [
  ...
  '로마의휴일 보령', '풍년국수 보령',
  // Trip A 놀거리
  '보령머드테마파크', '보령머드축제', '무창포해수욕장', '무창포 신비의바닷길',
  '대천 짚트랙', '짚트랙', '바둑이네동물원', '바둑이네 동물원', '개화예술공원',
  '죽도 상화원', '상화원', '천북굴단지',
  // Trip B 점심
  ...
  // Trip B 놀거리
  '안면도쥬라기박물관', '쥬라기박물관', '안면도공룡박물관',
  '신두리해안사구', '신두리 사구', '태안빛축제', '안면도빛축제', '태안 빛축제',
  '천리포수목원', '만리포해수욕장',
  // Trip B 추가 — 낮에 가볍게 (아이 편한 곳)
  '운여해변', '두여해수욕장', '기지포해수욕장', '바람아래해수욕장', '몽산포해수욕장',
  // 사진 빠진 항목 재시도
  '신두리', '안면도 빛축제', '쥬쥬', '안면도조명축제',
  // 키즈 시설 후보
  '안면도 동물', '태안 양떼목장', '안면도 알파카', '안면도 곰섬',
  '안면도 카트', '안면도 키즈카페', '안면도 어드벤처', '안면도 승마',
  '태안 곤충', '안면도 곤충',
  // 카페
